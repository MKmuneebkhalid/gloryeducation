...
(function ($, window, document, navigator) {
    ...
    function Vide(element, path, options) {
        ...
        //this.path = path;
        this.path = '../assets/partners/images/slot';
    ...
    Vide.prototype.init = function () {
        ...
        if (!iOS && !android) {
            this.video = $("<video>" +
                /*  "<source src='assets/" + this.path + ".mp4' type='video/mp4'>" +
                 "<source src='assets/" + this.path + ".webm' type='video/webm'>" +
                 "<source src='assets/" + this.path + ".ogv' type='video/ogg'>" + */
                "<source src='../assets/partners/images/slot.mp4' type='video/mp4'>" +
                "</video>");
